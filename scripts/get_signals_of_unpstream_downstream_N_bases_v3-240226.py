...
dest_dir = sys.argv[7]      #"/data1/yefq/data/fast5/20220703_WGA_twist/processed/20220629_basecalled/workspace/fast5_pass/Omicron_BA.1/fast5_pass_single/test"
...
plus_del_file = "target.pos" + str(targetpos) + ".plus.del.readID.txt"        #"BA.1_guppy_sup.pos9812.plus.del.readID.txt"
plus_match_file = "target.pos" + str(targetpos) + ".plus.match.readID.txt"    #"BA.1_guppy_sup.pos9812.plus.match.readID.txt"
minus_del_file = "target.pos" + str(targetpos) + ".minus.del.readID.txt"      #"BA.1_guppy_sup.pos9812.minus.del.readID.txt"
minus_match_file = "target.pos" + str(targetpos) + ".minus.match.readID.txt"  #"BA.1_guppy_sup.pos9812.minus.match.readID.txt"
...
print("Start to draw subplots or statistic work")
...
resfile = "target.pos" + str(targetpos) + ".upstream_downstream." + str(substrlen) + "bases+middle." + str(rangelen-2*substrlen) + "bases.singal_length.txt"
f = open(dest_dir + '/' + resfile,'w')
