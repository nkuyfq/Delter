...
perl scripts/parse_variant_type_via_lofreq_output.pl "${snakemake_input[0]}" "${snakemake_input[1]}" "${snakemake_output[0]}" "${snakemake_output[1]}" "${snakemake_output[2]}" "${snakemake_output[3]}" "${snakemake_output[4]}" "${snakemake_output[5]}" "${snakemake_output[6]}"
