...
bash scripts/delinfo2Qscoreinfo_workflow.sh "${snakemake_input[0]}" "${snakemake_input[1]}" "${snakemake_input[2]}" "${snakemake_input[3]}" "${snakemake_params[opts1]}" "${snakemake_params[opts2]}" "${snakemake_params[opts3]}" "${snakemake_output[0]}"
