...
The Demo data could be accessed via https://figshare.com/articles/dataset/Example_dataset_containing_Fast5_and_BAM_files/26090575. User should modify the filepaths in the Delter.config.yaml in the snakemakeexample directory.
