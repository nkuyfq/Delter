...
python scripts/get_signals_of_unpstream_downstream_N_bases_v3.py ${snakemake_params[opts1]} "${snakemake_params[tombo]}" "${snakemake_params[readIDdir]}" "${snakemake_output[0]}" 
