...
perl scripts/get_qualityscore_of_upstream_downstream_N_bases_v2.pl ${snakemake_params[opts1]} "${snakemake_input[0]}" "${snakemake_output[0]}" "${snakemake_input[2]}"
perl scripts/get_qualityscore_of_upstream_downstream_N_bases_v2.pl ${snakemake_params[opts1]} "${snakemake_input[1]}" "${snakemake_output[1]}" "${snakemake_input[3]}"
perl scripts/get_qualityscore_of_upstream_downstream_N_bases_v2.pl ${snakemake_params[opts2]} "${snakemake_input[0]}" "${snakemake_output[2]}" "${snakemake_input[4]}"
perl scripts/get_qualityscore_of_upstream_downstream_N_bases_v2.pl ${snakemake_params[opts2]} "${snakemake_input[1]}" "${snakemake_output[3]}" "${snakemake_input[5]}"
